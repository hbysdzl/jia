 ...
 <div class="page-heading">
        ...
        <div class="wrapper">
          ...
          <?php foreach($roleList as $k=>$v):?>
                ...
                <tr class="">
                    <td style="width:20px;"><?php echo ($k+1); ?></td>
                    <td><?php echo ($v["role_name"]); ?></td>
                    <td>
                    	<?php foreach($v['chlia'] as $k1=>$v1):?>
                    	<span><?php echo ($v1["auth_name"]); ?></span>&nbsp|
                    	<?php endforeach;?>
                    </td>
                    <td>
                    	<a href="/index.php/Admin/Role/distribute/role_id/<?php echo ($v["role_id"]); ?>">分配权限</a>&nbsp|&nbsp
                    	<a href="<?php echo U('roleEdit?role_id='.$v['role_id']);?>">修改</a>&nbsp|&nbsp
                    	<a vo="<?php echo ($v["role_id"]); ?>" href="javascrip:0" class="del">删除</a>
                    </td>
                </tr>
          <?php endforeach;?>  
                </tbody>
