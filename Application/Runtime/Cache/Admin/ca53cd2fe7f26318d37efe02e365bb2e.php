    ...
    <tr>
     	<td>
     		<select name="fid">
     			...
     			<?php if(is_array($topList)): $i = 0; $__LIST__ = $topList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>">---<?php echo ($vo["name"]); ?>---</option><?php endforeach; endif; else: echo "" ;endif; ?>
     		</select>
	 	</td>
	</tr>
