...
<!--notification menu end -->
 ...
 <div class="page-heading">
        ...
        <div class="wrapper">
                ...
                <div class="clearfix">
                    <div class="btn-group">
                        <button id="editable-sample_new" class="btn btn-primary">
                          	<a href="<?php echo U('authAdd');?>">新增 </a><i class="fa fa-plus"></i>
                        </button>
                    </div>
                </div>
          ...
          <?php if(is_array($auth)): $i = 0; $__LIST__ = $auth;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                    ...
                    <td><?php echo ($vo["sorting"]); ?></td>
                    <td style="color:green">
                    	<span style="cursor:pointer;" ><a href="<?php echo U('authEdit','',false);?>/auth_id/<?php echo ($vo["auth_id"]); ?>">修改</a></span> |
                    	<span vo="<?php echo ($vo["auth_id"]); ?>" class="del"style="cursor:pointer;" >删除</span>
					</td>
...
.num{background:#34eb8a;margin:3px;width:20px;display:inline-block;padding-left:5px;color:#040906};
       ...
       <div style="margin-left:0px;"><?php echo $page;?></div>
        </div>
     </div>
...
$('.del').click(function(){
	...
	if(confirm('确定要删除吗？')){
		$.ajax({
			type:"get",
			url:"<?php echo U('ajaxdel','',false);?>/auth_id/"+id,
			dataType:"json",
