...
<form id="form_data" action="/index.php/Admin/Drawing/add.html" method="post" enctype="multipart/form-data">    
<table  style="width:50%;height:300px;margin-left:20px;font-size:16px">
    ...
    <tr><td><img src="" id="show" width='90px'></td></tr>
    ...
    <tr>
    	<td>
    		<?php if(is_array($res1)): $i = 0; $__LIST__ = $res1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input class="auth_rules" type="radio" name="ffg" value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?> &nbsp;&nbsp;&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
    	</td>
   </tr>
   <tr><th>户型</th></tr>
    <tr>
    	<td>
    		<?php if(is_array($res2)): $i = 0; $__LIST__ = $res2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input class="auth_rules" type="radio" name="fhx" value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
    	</td>
   </tr>
   <tr><th>面积</th></tr>
    <tr>
    	<td>
    		<?php if(is_array($res3)): $i = 0; $__LIST__ = $res3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input class="auth_rules" type="radio" name="fmj" value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
    	</td>
   </tr>
   <tr><th>造价</th></tr>
    <tr>
    	<td>
    		<?php if(is_array($res4)): $i = 0; $__LIST__ = $res4;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input class="auth_rules" type="radio" name="fzj" value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
    	</td>
   </tr>
   <tr><th>描述</th> </tr> 
