   ...
   <li class="active">禁用</li>
        ...
        <div class="wrapper">
             <div class="row">
              ...
              <form action="/index.php/Admin/Article/myDocumentLst" method="post">
          ...
          <?php if(is_array($document_arr)): $i = 0; $__LIST__ = $document_arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                    ...
                    <td style="color:green">
                    	<span style="cursor:pointer;" ><a href="<?php echo U('edit','',false);?>/cat_id/<?php echo ($vo["category_id"]); ?>/id/<?php echo ($vo["id"]); ?>">修改</a></span> |
