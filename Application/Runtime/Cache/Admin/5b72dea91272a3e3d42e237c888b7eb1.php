...
<table  style="width:50%;height:300px;margin-left:20px;font-size:16px">
    ...
    <tr>
      <td>
        <select name="fid">
          <?php if(is_array($mtype)): $i = 0; $__LIST__ = $mtype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($editData['fid']==$vo['id']){ $che='selected="selected"'; }else{ $che=''; } ?>
...
<script type="text/javascript">
	//表单提交
	actionForm("<?php echo U('brandEdit');?>","<?php echo U('brandIndex');?>");
