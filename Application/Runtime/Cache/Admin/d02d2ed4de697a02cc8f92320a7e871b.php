...
<section>
 ...
 <div class="page-heading">
        ...
        <div class="wrapper">
                ...
                <div class="clearfix">
                    <div class="btn-group">
                        <button id="editable-sample_new" class="btn btn-primary">
                          	<a href="<?php echo U('RoleAdd');?>">新增 </a><i class="fa fa-plus"></i>
                        </button>
                    </div>
                </div>
          ...
          <?php if(is_array($roleList)): $i = 0; $__LIST__ = $roleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                    <td style="width:20px;"><?php echo ($i); ?></td>
                    <td><?php echo ($vo["role_name"]); ?></td>
                    <td><a href="/index.php/Admin/Role/distribute/role_id/<?php echo ($vo["role_id"]); ?>">分配权限</a></td>
                    <td><a vo="<?php echo ($vo["role_id"]); ?>" href="javascrip:0" class="del">删除</a></td>
...
$('.del').click(function(){
	...
	if(confirm('确定要删除吗？')){
		$.ajax({
			type:"get",
			url:"<?php echo U('ajaxdel','',false);?>/role_id/"+id,
			dataType:"json",
