...
<table class="table_content" style="width:100%;height:650px;margin-left:10px;font-size:16px">
	<input type="hidden" name="id" value="<?php echo ($cat_arr["id"]); ?>">
    <tr><td><span style="color:red">*</span>上级分类:</td></tr>
   	<tr>
   		<td>
   			<select name="pid" style="width:340px">
   				<option value='0'>----顶级分类-----</option>
   				<?php if(is_array($one_cat)): $i = 0; $__LIST__ = $one_cat;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($cat_arr['pid']==$vo['id']):?>
   	...
   	<tr><td><input type="text" name="title"  size="40" value="<?php echo ($cat_arr["title"]); ?>"/></td></tr>
    <tr><td><span style="color:red">*</span>分类标识:</td></tr>
    <tr><td><input type="text" name="name" size='40' value="<?php echo ($cat_arr["name"]); ?>"></td></tr>
	...
	<tr><td><span style="color:red">*</span>排序（仅对当前层级有效）：<input type="text" name="sort" value='<?php echo ($cat_arr["sort"]); ?>' size='8'></td></tr>
	<tr>
		<td><span style="color:red">*</span>列表行数：&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			<input type="text" name="list_row" value="<?php echo ($cat_arr["list_row"]); ?>" size='10'>
		</td>
	</tr>                                       
</table>
...
<table class="table_content" style="display:none;width:100%;height:800px;margin-left:10px;font-size:16px;">		
	...
	<tr><td>网页标题:&nbsp&nbsp<input type="text" name="meta_title" size='40' value="<?php echo ($cat_arr["meta_title"]); ?>"></td></tr>
	
	<tr><td><span style="color:red">*</span>关键字：</td></tr>
	<tr><td><textarea name="keywords" rows='8' cols='50'><?php echo ($cat_arr["keywords"]); ?></textarea></td></tr>
	
	
	<tr><td><span style="color:red">*</span>描述：</td></tr>
	<tr><td><textarea name="description" rows='8' cols='50'><?php echo ($cat_arr["description"]); ?></textarea></td></tr>
	
	<tr><td><span style="color:red">*</span>频道模板：</td></tr>
	<tr><td><input type="text" name="template_index" size='50' value="<?php echo ($cat_arr["template_index"]); ?>"></td></tr>
	
	<tr><td><span style="color:red">*</span>列表模板：</td></tr>
	<tr><td><input type="text" name="template_lists" size='50' value="<?php echo ($cat_arr["template_lists"]); ?>"></td></tr>
	
	<tr><td><span style="color:red">*</span>详情模板：</td></tr>
	<tr><td><input type="text" name="template_detail" size='50' value="<?php echo ($cat_arr["template_detail"]); ?>"></td></tr>
	
	<tr><td><span style="color:red">*</span>编辑模板：</td></tr>
	<tr><td><input type="text" name="template_edit" size='50' value="<?php echo ($cat_arr["template_edit"]); ?>"></td></tr>
