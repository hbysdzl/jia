...
<table  style="width:400px;text-align:center;height:150px;margin-left:20px;font-size:16px">                
   <tr>
       <td>链接名称:</td>
       <td>
	      <input type="text" name="linkname" value="<?php echo ($editData["linkname"]); ?>" />
	   </td>
   </tr>
   <tr>
       <td>链接地址:</td>
       <td>
        <input type="text" name="url" value="<?php echo ($editData["url"]); ?>" />
     </td>
   </tr>
   	<tr>
...
//jQureForm插件提交表单
actionForm("<?php echo U('linkEdit');?>","<?php echo U('linkIndex');?>");
</script>>
