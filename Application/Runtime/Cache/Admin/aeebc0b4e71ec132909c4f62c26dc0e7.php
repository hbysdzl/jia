...
<div class="page-heading">
    <h3><?php echo ($title); ?></h3>
       <ul class="breadcrumb">
           ...
           <li><a href="<?php echo U('classIndex');?>">返回</a></li>
		    ...
		    <tr>
		     	<td>
		     		<select name="fid">
		     			...
		     			<?php if(is_array($parentList)): $i = 0; $__LIST__ = $parentList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($editData['fid']==$vo['id']){ $che='selected="selected"'; }else{ $che=''; } ?>
		     			<option value="<?php echo ($vo["id"]); ?>" <?php echo ($che); ?>>---<?php echo ($vo["name"]); ?>---</option><?php endforeach; endif; else: echo "" ;endif; ?>
		     		</select>
			 	</td>
			</tr>
		    <tr><th>名称</th></tr>
		    <tr><td><input type="text" name="name" value="<?php echo ($editData["name"]); ?>" /></td></tr>
...
<script type="text/javascript">
	//jqureForm插件提交表单
	actionForm("<?php echo U('classEdit');?>","<?php echo U('classIndex');?>");
</script> 
		<footer>
