...
<div class="page-heading">
    <h3><?php echo ($title); ?></h3>
       <ul class="breadcrumb">
           ...
           <li><a href="<?php echo U('homeProIndex');?>">返回</a></li>
...
<table  style="width:50%;height:300px;margin-left:20px;font-size:16px">
    ...
    <tr>
     	<td>
     		<select name="fid">
     			...
     			<option value="<?php echo ($vo["id"]); ?>" selected="selected">---<?php echo ($vo["gname"]); ?>---</option>
     			<?php else:?>
     			<option value="<?php echo ($vo["id"]); ?>">---<?php echo ($vo["gname"]); ?>---</option>
     			<?php endif; endforeach; endif; else: echo "" ;endif; ?>
     		</select>
	 	</td>
	</tr>
    ...
    <tr><th>名称</th></tr>
    <tr><td><input type="text" name="gname" value="<?php echo ($dataEd["gname"]); ?>"/></td></tr>
