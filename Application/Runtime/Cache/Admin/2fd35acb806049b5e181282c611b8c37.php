 ...
 <ul class="breadcrumb">
   ...
   <li class="active">禁用</li>
        ...
        <div class="wrapper">
          ...
          <?php if(is_array($cat_arr)): $i = 0; $__LIST__ = $cat_arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="abc" id="<?php echo ($vo["id"]); ?>" pid="<?php echo ($vo["pid"]); ?>">
                	<?php if($vo['pid']==0):?>
