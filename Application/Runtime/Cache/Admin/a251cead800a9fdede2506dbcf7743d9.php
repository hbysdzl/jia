...
<div class="page-heading">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo U('authList');?>">返回</a>
                </li>
...
<table  style="width:400px;text-align:center;height:300px;margin-left:20px;font-size:16px">
   ...
   <tr>
	   <input type="hidden" name="auth_id" value="<?php echo ($auth_edit["auth_id"]); ?>">
       <td>权限名称:</td>
       <td>
	      <input type="text" name="auth_name" value="<?php echo ($auth_edit["auth_name"]); ?>" />
	   </td>
   </tr>
    <tr>
       ...
       <td>
			<select name="auth_pid">
				...
				<?php if(is_array($auth_1)): $i = 0; $__LIST__ = $auth_1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['auth_id']==$auth_edit['auth_pid']):?>
				<option value="<?php echo ($vo["auth_id"]); ?>" selected="selected"><?php echo ($vo["auth_name"]); ?></option>
				<?php else:?>
				<option value="<?php echo ($vo["auth_id"]); ?>"><?php echo ($vo["auth_name"]); ?></option>
				<?php endif; endforeach; endif; else: echo "" ;endif; ?>
			</select>
	   </td>
   	</tr>
    <tr>
       <td>控制器名:</td>
       <td><input type="text" name="auth_c" value="<?php echo ($auth_edit["auth_c"]); ?>"/></td>
   	</tr>
   	<tr>
       <td>方法名:</td>
       <td><input type="text" name="auth_a" value="<?php echo ($auth_edit["auth_a"]); ?>"/></td>
   	</tr>
   	<tr>
       <td>排序:</td>
       <td><input type="text" name="sorting" value="<?php echo ($auth_edit["sorting"]); ?>"/></td>
   	</tr>  
   	<tr>
		...
		success:function(data){
			if(data.ok==0){
				...
				$('#tishi').fadeOut(3000);
					...
					setTimeout(function(){
						location.href="<?php echo U('authList');?>"
					},3000);
