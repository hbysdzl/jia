                ...
                <ul class="notification-menu">
                    ...
                    <li>
                        ...
                        <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                            <li><a href="#"><i class="fa fa-user"></i>修改</a></li>
...
<div class="page-heading">
 <h3>添加角色</h3>
    <ul class="breadcrumb">
       <li><a href="#">控制面板</a></li>
       <li><a href="<?php echo U('role_list');?>">返回</a></li>
    ...
    <tr>
       ...
       <td>
			<select name="auth_pid">
				...
				<?php if(is_array($auth_1)): $i = 0; $__LIST__ = $auth_1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["auth_id"]); ?>"><?php echo ($vo["auth_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
	   </td>
   	</tr>
    <tr>
