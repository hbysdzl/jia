...
<div class="page-heading">
    <h3><?php echo ($title); ?></h3>
       <ul class="breadcrumb">
           ...
           <li><a href="<?php echo U('gzindex');?>">返回</a></li>
...
<table  style="width:50%;height:300px;margin-left:20px;font-size:16px">
    ...
    <tr><td><input type="text" name="name" size="47" value="<?php echo ($res["name"]); ?>"/> </td></tr>
   	...
   	<tr><th>公司名称:</th></tr>
    <tr><td><input type="text" name="cname" size="47" value="<?php echo ($res["cname"]); ?>"/> </td></tr>
    
    <tr><th>图片 （*上传图片格式为：140*140；png/jpg；圆形透明底！）:</th></tr>
    <tr><td><input type="file" name="photo" id="picture"/></td></tr>
    <tr><td><img src="/Public/Upload/<?php echo ($res["photo"]); ?>" id="ps" width='100px'></td></tr>
   
    <tr><th>工作经验:</th></tr>
    <tr><td><input type="text" name="exp" size="47" value="<?php echo ($res["exp"]); ?>"/></td></tr>
  
  	<tr><th>员工人数（请填写数字）</th>   
    <tr><td><input type="text" name="team" size="47" value="<?php echo ($res["team"]); ?>"/></td></tr>
   	
   	<tr><th>服务地区（如：火炬区，民众，东区）</th>   
    <tr><td><input type="text" name="map" size="47" value="<?php echo ($res["map"]); ?>"/></td></tr>
   	
   	<tr><th>完成订单（请填写数字）</th>   
    <tr><td><input type="text" name="order" size="47"/ value="<?php echo ($res["order"]); ?>"></td></tr>
   	<tr><th>空间:</th></tr>
    <tr>
    	<td>
    		<?php if(is_array($space)): $i = 0; $__LIST__ = $space;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(in_array($vo['id'],$res['space'])){ $check='checked=checked'; }else{ $check=''; } ?>
    		<input class="auth_rules" type="checkbox" name="space[]" value="<?php echo ($vo["id"]); ?>" <?php echo ($check); ?>><?php echo ($vo["name"]); ?> &nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
    	</td>
   </tr>
   <tr><th>风格:</th></tr>
    <tr>
    	<td>
    		<?php if(is_array($style)): $i = 0; $__LIST__ = $style;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(in_array($vo['id'],$res['style'])){ $check='checked=checked'; }else{ $check=''; } ?>
    		<input class="auth_rules" type="checkbox" name="style[]" value="<?php echo ($vo["id"]); ?>" <?php echo ($check); ?>><?php echo ($vo["name"]); ?>&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
    	</td>
   </tr>
   <tr><th>个人简历</th> </tr> 
    <tr><td><textarea name="info" style="height:200px;width:400px"><?php echo ($res["info"]); ?></textarea></td></tr>    
   	<tr><th>设计理念</th></tr>   
    <tr><td><textarea name="idea" style="height:200px;width:400px"><?php echo ($res["info"]); ?></textarea></td></tr>   
    <tr><th>个人荣誉</th></tr> 
    <tr><td><textarea name="honor" style="height:200px;width:400px"><?php echo ($res["honor"]); ?></textarea></td></tr>    
   	
   	<tr><th>座右铭&nbsp&nbsp<span class="check-tips">(请填20勿超出字)</span></th></tr>
    <tr><td><input type="text" class="text input-large" name="say" size="47" value="<?php echo ($res["say"]); ?>"></td></tr>
        ...
        success: function(data) {
        	if(data.ok==0){
				...
				$('#tishi').fadeOut(3000);
					...
					setTimeout(function(){
						location.href="<?php echo U('gzindex');?>";
					},3000);
