...
<table  style="width:50%;height:300px;margin-left:20px;font-size:16px">
    ...
    <tr><td><img src="<?php echo C('IMG_PATH').'/'.$res['photo'];?>" id="ps" width='150px'></td></tr>
   ...
   <tr><th>个人简历</th> </tr> 
    <tr><td><textarea name="info" style="height:200px;width:400px"><?php echo ($res["info"]); ?></textarea></td></tr>    
   	<tr><th>设计理念</th></tr>   
    <tr><td><textarea name="idea" style="height:200px;width:400px"><?php echo ($res["idea"]); ?></textarea></td></tr>   
    <tr><th>个人荣誉</th></tr> 
