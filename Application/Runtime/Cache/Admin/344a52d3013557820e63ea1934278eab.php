...
<div class="page-heading">
    <h3><?php echo ($title); ?></h3>
       <ul class="breadcrumb">
           ...
           <li><a href="<?php echo U('styleIndex');?>">返回</a></li>
    ...
    <tr>
     	<td>
     		<select name="fid">
     			...
     			<?php if(is_array($topList)): $i = 0; $__LIST__ = $topList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($editData['id']==$vo['id']){ continue; } ?>
        ...
        success: function(data) {
        	if(data.ok==0){
				...
				$('#tishi').fadeOut(3000);
					...
					setTimeout(function(){
						location.href="<?php echo U('styleIndex');?>";
					},3000);
