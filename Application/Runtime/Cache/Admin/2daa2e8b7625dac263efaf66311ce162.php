                ...
                <div class="clearfix">
                    <div class="btn-group">
                        <button id="editable-sample_new" class="btn btn-primary">
                          	<a href="<?php echo U('linkAdd');?>">新增 </a><i class="fa fa-plus"></i>
                        </button>
                    </div> 
                </div>
            <div style="float:right;margin-top:-40px;">
            	<form action="/index.php/Admin/Reguser/linkIndex" method="post">
	                <div class="clearfix" style="margin-bottom:15px;">
	                	 <input type="text" name="linkname" size="30" value="请输入名称"/>
	                    <div class="btn-group">
                ...
                <tbody> 
          		<?php if(is_array($linkList)): $i = 0; $__LIST__ = $linkList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                    ...
                    <?php if($vo['status']==1): ?><span style="cursor:pointer;" id="<?php echo ($vo["id"]); ?>"><a href="javascript:void(0);" onclick='status("<?php echo U('setStatus','method=forbid&mo=furl&id='.$vo['id']);?>",<?php echo ($vo["id"]); ?>)'>禁用|</a></span> 
                    <?php else: ?>
                    <span style="cursor:pointer;" id="<?php echo ($vo["id"]); ?>"><a href="javascript:void(0);" onclick='status("<?php echo U('setStatus','method=resumew&mo=furl&id='.$vo['id']);?>",<?php echo ($vo["id"]); ?>)'>启用|</a></span><?php endif; ?>	
                    	<span style="cursor:pointer;" ><a href="<?php echo U('linkEdit','',false);?>/id/<?php echo ($vo["id"]); ?>">修改</a></span> |
                    	<span id="<?php echo ($vo["id"]); ?>" class="del"style="cursor:pointer;" onclick='status("<?php echo U('setStatus','method=delete&mo=furl&id='.$vo['id']);?>",<?php echo ($vo["id"]); ?>)'>删除</span>
                    </td> 
