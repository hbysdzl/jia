...
;(function($){
    ...
    Caroursel.prototype = {
        ...
        setFirstPosition:function(){
            ...
            //设置两个按钮的样式
            this.prevBtn.css({"width":width , "height":this.setting.posterHeight*this.setting.scale,"zIndex":Math.ceil(this.posterItems.size()/2)});
            this.nextBtn.css({"width":width , "height":this.setting.posterHeight*this.setting.scale,"zIndex":Math.ceil(this.posterItems.size()/2)});
